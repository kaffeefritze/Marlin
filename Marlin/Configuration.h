...
#define STRING_CONFIG_H_AUTHOR "Marcel Pietsch" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hannelore"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 38.62
    #define DEFAULT_Ki 4.59
    #define DEFAULT_Kd 81.29
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
   #define DEFAULT_bedKp 299.58
   #define DEFAULT_bedKi 49.16
   #define DEFAULT_bedKd 1217.11
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-40.5,12, 0 }
